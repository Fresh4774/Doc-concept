  ...
  return (
    <Fragment>
      ...
      <div className={styles.privacypolicy}>
          ...
          <p>
          This privacy policy for Aquin ("we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:
          </p>
          <ul>
            <li>
            Visit our website at https://aquin.app, or any website of ours that links to this privacy policy
            </li>
            <li>
            Download and use our mobile application (Aquin), or any other application of ours that links to this privacy policy
            </li>
            <li>
         ...
         <strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. Learn more about personal information you disclose to us.
          ...
          <p>
         <strong>Do we process any sensitive personal information?</strong> We do not collect any information from third parties.
          </p>
          <p>
...
Personal information you disclose to us
  ...
  <li>Contact or authentication data</li>
         ...
         <strong>Application Data.  </strong> If you use our application(s), we also may collect the following information if you choose to provide us with access or permission:
          ...
          <ul>
  <li><em>Mobile Device Access. </em> We may request access or permission to certain features from your mobile device, including your mobile device's camera, microphone, storage, and other features. If you wish to change our access or permissions, you may do so in your device's settings.</li>
...
<p>
  ...
  <li><strong>To authenticate users and provide secure access to the application.</strong> We use your login information (such as email and password) to verify your identity and grant you access to our app.</li>
  <li><strong>To save user conversations with Al.</strong> We store your conversations with our Al to enhance your experience by allowing you to revisit previous interactions and maintain continuity.</li>
  <li><strong>To provide personalized recommendations and responses.</strong> We analyze your interaction data to tailor our Al responses and suggestions to better meet your needs and preferences.</li>
  <li><strong>To authenticate users and provide secure access to the application. </strong> We use your login information (such as email and password) to verify your identity and grant you access to our app.</li>
  <li><strong>To save user conversations with Al.</strong> We store your conversations with our Al to enhance your experience by allowing you to revisit previous interactions and maintain continuity.</li>
  <li><strong>To provide personalized recommendations and responses.</strong> We analyze your interaction data to tailor our Al responses and suggestions to better meet your needs and preferences.</li>
</ul>
...
<p>
            <strong><em> In Short: </em></strong> <em> We only process your personal information when we believe it is necessary and we have a valid legal reason (i.e., legal basis) to do so under applicable law, like with your consent, to comply with laws, to provide you with services to enter into or fulfil our contractual obligations, to protect your rights, or to fulfill our legitimate business interests. </em>
          </p>

          <p>
            <strong><em><u>If you are located in the EU or UK, this section applies to you.</u></em></strong>
          </p>
  ...
  <ul>
  <li>Ensure the security of user accounts and protect against unauthorized access.</li>
  <li>Improve user experience and provide personalized service by retaining conversation history.</li>
  <li>Enhance the relevance and usefulness of the app's features for each user.</li>
</ul>
  </li>
...
<p>
            <strong><em><u>If you are located in Canada, this section applies to you.</u></em></strong>
          </p>
...
<p>
  ...
  <li><strong>Allow Users to Connect to Their Third-Party Accounts: </strong> Google account and Twitter account</li>
  <li><strong>Cloud Computing Services: </strong> Cloudflare</li>
  <li><strong>Communicate and Chat with Users:</strong> E-mail, Google Form and Social Media</li>
  <li><strong>Content Optimization: </strong> Google Site Search and YouTube video embed</li>
  <li><strong>Data Backup and Security:</strong> Google Drive Backup</li>
  <li><strong>Functionality and Infrastructure Optimization: </strong> Firebase Realtime Database Cloud Storage for Firebase, Cloud Functions for Firebase, Cloud Firestore, Vercel and Cloudflare</li>
  <li><strong>Retargeting Platforms: </strong> Google Analytics Remarketing and Google Ads Remarketing</li>
  <li><strong>Social Media Sharing and Advertising: </strong> Instagram advertising and Twitter advertising</li>
  <li><strong>User Account Registration and Authentication: </strong> Google OAuth 2.0 and Twitter OAuth</li>
  <li><strong>User Commenting and Forums: </strong> Google Forms and Discord Server</li>
  <li><strong>Web and Mobile Analytics: </strong> Google Analytics, Cloudflare and Vercel</li>
  <li><strong>Website Hosting: </strong> Vercel, Godaddy and Cloudflare</li>
  <li><strong>Website Performance Monitoring: </strong> Vercel, Godaddy and Cloudflare</li>
  <li><strong>Website Testing: </strong> Cloudflare</li>
</ul>
...
<p>
          ...
          <p>
         Specific information about how we use such technologies and how you can refuse certain cookies is set out in our <a href="/cookiepolicy" target="_blank" >Cookie Policy</a>.
          </p>
...
<p>
          ...
          <h3>7. Is your information transferred internationally?</h3>
<p>
...
<p>
            <strong><em> In Short: </em></strong> <em> We keep your information for as long as necessary to fulfil the purposes outlined in this privacy policy unless otherwise required by law. </em>
          </p>
...
<p>
To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at <a href="mailto:aquin.explore@gmail.com" target='_blank' rel="noreferrer">aquin.explore@gmail.com</a> or by referring to the contact details at the bottom of this document.
          </p>
...
<p>
            <strong><em> In Short: </em></strong> <em> Yes, we will update this policy as necessary to stay compliant with relevant laws. </em>
          </p>
          ...
          <p>
          Mail us at <a href="mailto:aquin.explore@gmail.com" target="_blank" rel="noreferrer" >aquin.explore@gmail.com</a>
          </p>

          <h3>15. How can you review, update, or delete the data we collect from you?</h3>

          <p>
          Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, <a href="/fb" target="_blank" >please fill out and submit a data subject access request form</a>.
          </p>
