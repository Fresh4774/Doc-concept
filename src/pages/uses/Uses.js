  ...
  return (
    <Fragment>
      <ProjectContainer className={styles.uses}>
        ...
        <ProjectHeader
          title="Aquin 2"
          description="Aquin 2 has been released on March 10 2024, The first ever mega-update to change, upgrade everything, with tons of features, Team Aquin has dedicated each of their atoms into this update!"
        />
