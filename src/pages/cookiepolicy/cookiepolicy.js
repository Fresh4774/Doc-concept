  ...
  return (
    <Fragment>
      ...
      <div className={styles.cookiePolicy}>
          ...
          <p>
          This Cookie Policy explains how we at Aquin ("Company," "we," "us," and "our") uses cookies and
similar technologies to recognize you when you visit our website at https://aquin.app ("Website",
“Web App”, “Application”). It explains what these technologies are and why we use them, as well as
...
work more efficiently, as well as to provide reporting information.
          ...
          <p>
          Cookies set by the website owner (in this case, Aquin) are called "first-party cookies." Cookies set by
...
enhance the experience on our Online Properties. Third parties serve cookies through our Website
...
to select which categories of cookies you accept or reject. Essential cookies cannot be rejected as
...
information about how to manage cookies on the most popular browsers:
          ...
          <ul>
          <li>
  <a href="https://support.google.com/chrome/answer/95647#zippy=%2Callow-or-blockcookies" target='_blank' rel="noreferrer">Chrome</a>
</li>
<li>
  <a href="https://support.microsoft.com/en-us/windows/manage-cookies-in-microsoft-edge-view-allow-block-delete-and-use-168dab11-0753-043d-7c16-ede5947fc64d" target='_blank' rel="noreferrer">Internet Explorer</a>
</li>
<li>
  <a href="https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop?redirectslug=enable-and-disable-cookies-website-preferences&redirectlocale=en-US" target='_blank' rel="noreferrer">Firefox</a>
</li>
<li>
  <a href="https://support.apple.com/en-ie/guide/safari/sfri11471/mac" target='_blank' rel="noreferrer">Safari</a>
</li>
<li>
  <a href="https://support.microsoft.com/en-us/windows/microsoft-edge-browsing-data-and-privacy-bb8174ba-9d73-dcf2-9b4a-c582b4e640dd" target='_blank' rel="noreferrer">Edge</a>
</li>
<li>
  <a href="https://help.opera.com/en/latest/web-preferences/" target='_blank' rel="noreferrer">Opera</a>
</li>
          </ul>
...
<ul>
          <li>
  <a href="https://optout.aboutads.info/?c=2&lang=EN" target='_blank' rel="noreferrer">Digital Advertising Alliance</a>
</li>
<li>
  <a href="https://youradchoices.ca/" target='_blank' rel="noreferrer">Digital Advertising Alliance of Canada</a>
</li>
<li>
  <a href="https://www.youronlinechoices.com/" target='_blank' rel="noreferrer">European Interactive Digital Advertising Alliance</a>
</li>
          </ul>
...
player to block Flash Cookies storage using the tools contained in the <a href="https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager07.ht
ml" target='_blank' rel="noreferrer">Website Storage Settings Panel</a>. 
You can also control Flash Cookies by going to the <a href='https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager03.ht
ml' target='_blank' rel="noreferrer">Global Storage Settings Panel</a> and following the instructions (which may include instructions that explain, for example, how to
...
are on at the time).
          ...
          <p>Please note that setting the Flash Player to restrict or limit acceptance of Flash Cookies may reduce
or impede the functionality of some Flash applications, including, potentially, Flash applications used
in connection with our services or online content.</p>
...
may also employ technology that is used to measure the effectiveness of advertisements. They can
...
to you. The information collected through this process does not enable us or them to identify your
...
Cookie Policy regularly to stay informed about our use of cookies and related technologies.
          ...
          <br />
          <a href="mailto:aquin.explore@gmail.com">Mail us at aquin.explore@gmail.com</a>
          </p>
        </div>
      </ProjectContainer>
      <Footer />
