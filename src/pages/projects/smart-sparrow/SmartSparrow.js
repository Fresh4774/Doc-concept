...
const title = 'How?';
const description =
  'If you find Aquin-V1.5 challenging to use and are seeking clarity on its features or how to use its functionalities, youll find answers to all your queries over here.';
const roles = [
  'How to use Aquin-V1.5 ?',
  'How to call AI ?',
  ...
  return (
    <Fragment>
      <ProjectContainer className="spr">
        ...
        <ProjectSection>
          <ProjectTextRow>
            <ProjectSectionHeading>Aquin-V1.5 Application</ProjectSectionHeading>
            <ProjectSectionText>
            Aquin-V1.5 is a PWA and it works seamlessly across all browsers. Upon launching the application, youll be directly directed to a login page offering multiple options, Google, X, GitHub, and Microsoft, for authentication. After successfully logging in, youll get the access to Aquin AI and youll need a lot of time to explore its features.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
