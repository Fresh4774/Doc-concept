...
const Navbar = () => (
  ...
  >
    ...
    <div
      className={`${styles.innerWidth} mx-auto flex justify-between gap-4`}
    >
      <img
        src="./LOGO.png"
        alt="search"
